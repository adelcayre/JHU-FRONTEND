...
function RoutesConfig($stateProvider, $urlRouterProvider) {
  ...
  $stateProvider
    .state ('home', {
      url:'/JHU-FRONTEND/module9-solution/index.html#/',
      templateUrl:'/JHU-FRONTEND/module9-solution/home.html'
    })
    .state('categories', {
      url: '/JHU-FRONTEND/module9-solution/index.html#/categories',
      templateUrl: '/JHU-FRONTEND/module9-solution/categories.html',
      controller: 'CategoriesController as menu'
    })

    .state('items', {
      url: '/JHU-FRONTEND/module9-solution/index.html#/items/*categoryShortName',
